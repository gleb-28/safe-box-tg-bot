...
func (r *MessageLogRepo) GetByTelegramID(userID uint) ([]models.MessageLog, error) {
...
func (r *MessageLogRepo) GetByUserAndItem(userID, itemID uint) ([]models.MessageLog, error) {
	var logs []models.MessageLog
